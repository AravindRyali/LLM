...
model_complete_filepath = '/Users/aravindryali/Desktop/Studies/GPT/gpt4all-falcon-newbpe-q4_0.gguf'
...
def prompt_gpt(audio):
    global listening_for_wake_word, stop_listening
    try:
        ...
        if len(prompt_text.strip()) == 0:
            ...
            if stop_command in prompt_text.lower():
...
def start_listening():
    ...
    while not stop_listening:
        time.sleep(1)
    print('Script has stopped listening.')
